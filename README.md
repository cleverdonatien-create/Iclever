...
<body>
    ...
    <script>
        ...
        yesBtn.addEventListener('touchstart', (e) => { e.preventDefault(); startFinalStep(); });
                ...
                triggerWarning("😉", "Just say yes, make it different now.");
            } 
            else if (totalClicks >= 20) {
                noBtn.style.padding = "5px 10px";
                noBtn.style.fontSize = "0.6rem";
                feedback.innerText = "Don't you get tired? 😂";
            }
        }

        function triggerWarning(emoji, message) {
            warnEmoji.innerText = emoji;
        ...
        yesBtn.addEventListener('touchstart', (e) => { e.preventDefault(); celebrate(); });
    </script>
</body>
</html>
